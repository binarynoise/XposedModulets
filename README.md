...
| [AntiWakeLock](AntiWakeLock) | [@programminghoch10](https://github.com/programminghoch10) | Disable WAKE_LOCK and FLAG_KEEP_SCREEN_ON | [GitHub](https://github.com/binarynoise/XposedModulets/releases?q=AntiWakeLock) |
...
| [DisableSounds](DisableSounds) | [@programminghoch10](https://github.com/programminghoch10) | Disable various system sounds | [GitHub](https://github.com/binarynoise/XposedModulets/releases?q=DisableSounds) |
...
| [HideAbi](HideAbi) | [@binarynoise](https://github.com/binarynoise) | Hide specific CPU ABIs from apps. | [GitHub](https://github.com/binarynoise/XposedModulets/releases?q=HideAbi) |
| [Keep Playing, Soundcloud!](KeepPlayingSoundcloud) | [@binarynoise](https://github.com/binarynoise) | Prevents SoundCloud from stopping playback when the app is removed from recent apps | [GitHub](https://github.com/binarynoise/XposedModulets/releases?q=KeepPlayingSoundcloud) |
...
| [PreventAudioFocus](PreventAudioFocus) | [@programminghoch10](https://github.com/programminghoch10) | Prevents selected apps from acquiring audio focus | [GitHub](https://github.com/binarynoise/XposedModulets/releases?q=PreventAudioFocus) |
...
| [SensorMod](SensorMod) | [@programminghoch10](https://github.com/programminghoch10) | Selectively disable sensors on your device | [GitHub](https://github.com/binarynoise/XposedModulets/releases?q=SensorMod) |
